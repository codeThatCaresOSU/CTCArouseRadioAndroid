...
public class BlurredBackground {
    ...
    public BlurredBackground(Bitmap originalBitmap,int radius, boolean canReuseInBitmap) {
        this.originalBitmap = originalBitmap;
        blurredBitmap = doBlur(originalBitmap, radius, canReuseInBitmap);
    ...
    public int getTextColorFromBackground() {
