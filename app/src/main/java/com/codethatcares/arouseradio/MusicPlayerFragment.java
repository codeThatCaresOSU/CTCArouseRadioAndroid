...
public class MusicPlayerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Bitmap originBitmap = Bitmap.createBitmap(BitmapFactory.decodeResource(getResources(), R.drawable.samplecover2));
        ...
        Bitmap backgroundBlurred = doBlur(originBitmap, 180, false);
        backgroundImage.setImageBitmap(backgroundBlurred);
